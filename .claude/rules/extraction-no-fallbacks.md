---
paths:
  - "squads/design-ops/scripts/extract-from-url/**"
  - "squads/design-ops/scripts/**/*extract*"
  - "squads/design-system/**/extract*"
  - "apps/design/**"
  - "apps/aiox-squad-design/**"
  - "packages/@sinkra/design-tokens-base/**"
  - "**/DESIGN.md"
  - "**/preview.json"
