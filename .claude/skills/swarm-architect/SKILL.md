...
description: "Use for designing, spawning, and coordinating multi-agent systems — subagents, agent teams, parallel execution patterns, worktree isolation, and swarm"
version: "1.0.0"
agent: "mastery-swarm-orchestrator"
user-invocable: true
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      1. Show: "{icon} Welcome" + permission badge from current permission mode (e.g., [⚠️ Ask], [🟢 Auto], [🔍 Explore])
...
knowledge_base:
  ...
  # ── LAYER 5: Production-Scale Patterns (framework) ─────

  production_scale_patterns:
    description: |
      Patterns derived from framework's production architecture for scaling beyond
  ...
  native_swarm_primitives:
    ...
    TeamCreate:
      ...
      critical_constraints:
        ...
        - "One team per LEADER — error 'Already leading team' if leader tries to create second. TeamDelete() first to release."
    ...
    SendMessage:
      ...
      api: 'SendMessage({ to: "backend-dev", summary: "API spec ready", message: "API spec ready in api-spec.yaml" })'
      note: "summary is REQUIRED for plain text messages to teammates. NOT required for structured messages (shutdown_request, etc)."
      characteristics:
