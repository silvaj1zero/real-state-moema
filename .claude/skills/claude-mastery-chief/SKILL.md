...
description: "Claude Code Mastery Orchestrator (claude-mastery-chief)"
version: "1.0.0"
context: fork
agent: "claude-code-mastery--claude-mastery-chief"
user-invocable: true
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      1. Show: "{icon} Welcome" + permission badge from current permission mode
...
|------|-------|---------|-------|------------|
| 🪝 | hooks-architect | Latch | Hooks, automation, damage control | `@claude-code-mastery:hooks-architect` |
| 🔌 | mcp-integrator | Piper | MCP servers, tool discovery, integration | `@claude-code-mastery:mcp-integrator` |
| 🐝 | swarm-orchestrator | Nexus | Subagents, agent teams, parallel execution | `@claude-code-mastery:swarm-orchestrator` |
| ⚙️ | config-engineer | Sigil | Settings, permissions, CLAUDE.md, sandbox | `@claude-code-mastery:config-engineer` |
| 🛠️ | skill-craftsman | Anvil | Skills, plugins, commands, context engineering | `@claude-code-mastery:skill-craftsman` |
| 📦 | project-integrator | Conduit | Project setup, CI/CD, AIOX integration | `@claude-code-mastery:project-integrator` |
| 🔭 | roadmap-sentinel | Vigil | Updates, roadmap, feature adoption, plan-first | `@claude-code-mastery:roadmap-sentinel` |
