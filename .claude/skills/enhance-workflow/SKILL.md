...
Task(prompt: "...", subagent_type: "aiox-architect", mode: "bypassPermissions")
...
Task(prompt: "agent 1...", subagent_type: "aiox-architect", run_in_background: true)  → returns output_file_1
Task(prompt: "agent 2...", subagent_type: "aiox-data-engineer", run_in_background: true)  → returns output_file_2
Task(prompt: "agent 3...", subagent_type: "aiox-devops", run_in_background: true)  → returns output_file_3
Task(prompt: "agent 4...", subagent_type: "aiox-ux", run_in_background: true)  → returns output_file_4
