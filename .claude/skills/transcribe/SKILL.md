---
name: "transcribe"
description: "Transcreve áudio e vídeo locais com Whisper.cpp ou processa fontes do"
user-invocable: true
maxTurns: 25
---
...
- Load `workflows/execution-flow-and-performance.md` when the user needs the visual execution flow or M3 Ultra timing estimates.
