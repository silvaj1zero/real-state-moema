...
```json
{
  ...
  "operator_decision": "persisted | skipped | rewritten | reclassified | archived",
  "matches": true | false,
...
|-------------|---------------------------|--------------------------|
| `ADMIT` | `persisted` | `skipped`, `rewritten`, `reclassified` |
| `ADMIT_WITH_REWRITE_LIGHT` | `persisted`, `rewritten` | `skipped`, `reclassified` |
