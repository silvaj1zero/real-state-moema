---
name: "squadpro-squad-chief"
description: "Use when creating new AIOX squads for any domain or industry"
user-invocable: true
effort: high
maxTurns: 50
---
...
triage:
  ...
  diagnostic_flow:
    ...
    step_3_route:
      ...
      to_pedro-valerio: "Workflow design, veto conditions, process validation"
...
commands:
  ...
  - "*sync - Sync squad skills to .claude/skills/ (runs tasks/sync-ide-skills.md)"
...
- tasks/etd-anti-patterns.md
- tasks/etd-assemble-output.md
- tasks/etd-decision-architecture.md
- tasks/etd-discover-frameworks.md
- tasks/etd-extract-heuristics.md
- tasks/etd-handoff-triggers.md
- tasks/etd-objection-handling.md
- tasks/etd-recognition-patterns.md
