...
- [ ] Confirmar com a família (**Dennis** + Clarisia + demais herdeiros): termo de quitação do Banco Máxima + situação da execução fiscal (penhora Av.11).
